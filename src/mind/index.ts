...
export type { GrowthEvent, UserPreferences, RelationshipState, UserPatterns, KnownFact, BehavioralScript } from "./self-model";
...
export { updateMoods, computeMoodSignals, computeMoodFeedbacks, snapshotMoods, updatePrimarySystems, initPrimarySystems, PANIKSEPP_SYSTEMS } from "./mood";
export type { MoodSnapshot, MoodDimension, MoodForces, PankseppPrimarySystem } from "./mood";
export { inferInteroceptiveState, updateInteroceptivePrecision, cardiacPhaseTransition, cardiacArousalTransition, observationLikelihood, updateInteroceptiveBelief, initInteroceptiveBelief } from "./interoception";
export type { InteroceptiveState, InteroceptionConfig, InteroceptiveHiddenState, InteroceptiveObservation, InteroceptivePolicy, InteroceptivePrecisionParams } from "./interoception";
...
export { computePrecisionWeights, unifiedPredictionError, shouldReflect } from "./precision-router";
export type { PrecisionWeights } from "./precision-router";
export { AllostaticSelfEfficacy } from "./meta-cognition";
